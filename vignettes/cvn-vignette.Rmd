...
![*Unweighted meta-graph showing a grid. B = baseline, FU1 = First follow up, FU2 = second follow up*](pics/mg-ex-uw.png){width=50%}
...
In the following, we want to investigate the CVNs with the ids 3 and 6.
This is easier if we extract these CVNs into new single objects.
